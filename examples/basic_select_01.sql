...
SELECT r.rental_date AS 'Rental Date' , r.inventory_id AS Inwentory
FROM rental AS r
LIMIT 501;

SELECT r.rental_date 'Rental Date' , r.inventory_id Inwentory
FROM rental r
LIMIT 501;
...
SELECT actor.actor_id, first_name, last_name
FROM actor
WHERE actor_id < 100 or first_name = 'KENNETH'
LIMIT 501;
