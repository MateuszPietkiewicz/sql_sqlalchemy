...
SELECT CASE @Var
           WHEN 666 THEN 'Dupa'
           WHEN 42 THEN 'Kwiatki'
           ELSE 'last' END AS result;

SELECT CASE
           WHEN @Var = 666 THEN 'Dupa'
           WHEN @Var = 42 THEN 'Kwiatki'
           ELSE 'last' END AS result;
...
SELECT CASE
           WHEN (@v1 = 11 AND @v2 = 12) THEN 'Dupa'
           WHEN (@v1 = 11 AND @v2 = 13) THEN 'Kwiatki'
           ELSE 'last' END AS result;

SELECT IF(1 > 2, 'ajaj', 'jaja');
