...
with Session() as session:
    query = (
        sa.select(
            ...
            Film.description.label('Film description'),
    ...
    results = list(result_proxy.mappings()) #[row._asdict() for row in result_proxy]
...
wb.save(filename="sakila_films.xlsx")